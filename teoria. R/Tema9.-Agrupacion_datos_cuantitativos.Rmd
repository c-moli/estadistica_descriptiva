...
#la precisión sería la unidad más pequeña en al que se incrementan llso datos. En este caso los datos tienen hasta un decimal, por lo que la precisión sería de 0.1
...
#se redondea por arriba a la precisión. No tendría sentido dejarlo en 1.25 cuando los datos solo llegan a una cifra decimal. Si A hubiese dado 1.2 se hubiese redondeado también a 1.3 
...
#la precisión sería la unidad más pequeña en la que se incrementan los datos. En este caso los datos tienen hasta un decimal, por lo que la precisión sería de 0.1
