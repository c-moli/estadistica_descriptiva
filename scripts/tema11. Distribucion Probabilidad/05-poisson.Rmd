...
Mide el nº de eventos en un cierto intervalo de tiempo
...
## En `R`
```{r}
l = 5 #lamda, el valor esperado (esperanza) 
plot(0:20, dpois(x = 0:20, lambda = l)) #probabilidad desde 0 errores hasta 20 por página sabiendo que la esperanza es de 5
ppois(0:20, l)
qpois(0.5, 5)
